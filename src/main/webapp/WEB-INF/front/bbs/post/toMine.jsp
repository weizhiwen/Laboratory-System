    ...
    <div class="main"  style="margin-top: 10px;">
        <div class="row container">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="glyphicon glyphicon-envelope"></span> 我的帖子 <a href="#" class="pull-right">查看更多</a></h3>
                    </div>
                    <div class="panel-body">
                        <div class="list-group">
                            <s:iterator value="#request.bbsPostListOfMine">
                                <div class="row">
                                    <a href="post_toDetail.action?id=${id}" target="_blank" class="list-group-item">${title}<span class="pull-right">${creatTime}</span></a>
                                    <span class="pull-right"><a href="post_toEdit.action?id=${id}">修改</a>&nbsp;<a href="post_delete.action?id=${id}" onclick="return confirm('确认要删除吗？')">删除</a>&nbsp;&nbsp;</span>
                                </div>
                            </s:iterator>
                        </div>
                    </div>
