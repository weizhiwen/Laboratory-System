...
<div class="container-fluid">
    <div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
        <form class="form-horizontal" action="departhead_add.action">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="系主任" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-inline">
                <input type="submit" class="btn btn-primary" value="新增系主任">
