...
<div class="container-fluid">
    <div class="col-lg-4 col-md-6 col-sm-8 col-xm-12">
        <form class="form-horizontal" action="role_edit.action">
            <input type="hidden" name="id" value="${requestScope.role.id}">
            <div class="form-group">
                <label class="control-label">角色名：</label>
                <input type="text" class="form-control" name="name" value="${requestScope.role.name}" required>
            </div>
            <div class="form-group">
                <label class="control-label">角色描述：</label>
                <input type="text" class="form-control" name="description" value="${requestScope.role.description}" required>
            </div>
